...
router = Device(host='10.1.1.10', username='u1', password='cisco')
router.connect()
router.authenticate()

commands = ['enable', 'cisco', 'conf t', 'interface loopback 0', 'ip address 1.1.1.1 255.255.255.255', 'exit',
            'router ospf 1', 'net 0.0.0.0 0.0.0.0 area 0', 'end', 'terminal length 0', 'show ip protocols', 'exit']
